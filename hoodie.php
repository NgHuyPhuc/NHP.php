                            ...
                            <div class="home-product">
                                <div class="grid-row">
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Burn It All Down Worlds 2021" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct3.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Burn It All Down Worlds 2021</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie The Next Level" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct0.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Elden Ring Chibi" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie1.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Elden Ring Chibi</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Elden Ring" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie2.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Elden Ring</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Corrupted Monk - Sekiro Emblem Collection" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie3.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Corrupted Monk - Sekiro Emblem Collection</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Blazing Bull - Sekiro Emblem Collection" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie4.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Blazing Bull - Sekiro Emblem Collection</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Sword Saint - Sekiro Emblem Collection" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie5.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Sword Saint - Sekiro Emblem Collection</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Loaded Shuriken - Sekiro Emblem Collection" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie6.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Loaded Shuriken - Sekiro Emblem Collection</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Lady Butterfly - Sekiro Emblem Collection" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie7.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Lady Butterfly - Sekiro Emblem Collection</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Blinky - Pacman" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie8.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Blinky - Pacman</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="SHoodie Disconnect" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie9.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">SHoodie Disconnect</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <adiv href="" alt="Hoodie Thế Giới Shadow of the Colossus" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie10.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Thế Giới Shadow of the Colossus</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </adiv>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Mega Man Project" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie11.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Mega Man Project</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Contro" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/hoodie12.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Contro</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
