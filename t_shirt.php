                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid__column-10 product-main">
                            <div class="home-filter border-bottom">
                                <h2 class="home-filter-title">Áo Thun Mới Nhất</h2>
                                ...
                                <div class="grid-row">
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/ninja.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Ninja disguise</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="ÁÁo thun dài tay Burn It All Down Worlds 2021" class="new-shirt-item">
                                            ...
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">ÁÁo thun dài tay Burn It All Down Worlds 2021</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Burn It All Down Worlds 2021" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct2.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Burn It All Down Worlds 2021</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Sonic Thư Giãn Tí" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/new_shirt2.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Sonic Thư Giãn Tí</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Sonic Thư Giãn Tí" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct4.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Sonic Thư Giãn Tí</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Sonic Thư Giãn Tí" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct5.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Miss Minutes-Loki" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct6.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Miss Minutes-Loki</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun dài tay Miss Minutes - Loki" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/homeproduct7.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun dài tay Miss Minutes - Loki</h4>
                                                <span class="new-shirt-item__price-current">280,000đ</span>
                                                <span class="new-shirt-item__price-old">320,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Miss Minutes - Loki" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/new_shirt3.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Miss Minutes - Loki</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Loki - Back To The Sacred Timeline" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/home-product8.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Loki - Back To The Sacred Timeline</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
