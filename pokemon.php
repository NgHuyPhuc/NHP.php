                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid__column-10 product-main">
                            <div class="home-filter border-bottom">
                                <h2 class="home-filter-title">Pokemon</h2>
                            ...
                            <div class="home-product">
                                <div class="grid-row">
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Snorlax Đừng Làm Phiền" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon1.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Snorlax Đừng Làm Phiền</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Snorlax Đừng Làm Phiền" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon2.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Snorlax Đừng Làm Phiền</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">4500,000đ</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Pikachu" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon3.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Pikachu</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Pokémon: Let's Go - Switch" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon4.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Pokémon: Let's Go - Switch</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Ruby & Sapphire - Gameboy Advance" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon5.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Ruby & Sapphire - Gameboy Advance</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Pikachu Not Today" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon6.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Pikachu Not Today</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Slowpoke Bình Tĩnh Thôi" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon7.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Slowpoke Bình Tĩnh Thôi</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Psyduck Luôn Luôn Lú" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon8.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Psyduck Luôn Luôn Lú</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Snorlax Đừng Làm Phiền" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon9.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Snorlax Đừng Làm Phiền</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Pokemon Doodle" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon10.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Pokemon Doodle</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Choose Your World" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon11.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Choose Your World</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Slowpoke Bình Tĩnh Thôi" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon12.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Slowpoke Bình Tĩnh Thôi</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun dài tay Slowpoke Bình Tĩnh Thôi" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon13.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun dài tay Slowpoke Bình Tĩnh Thôi</h4>
                                                <span class="new-shirt-item__price-current">280,000đ</span>
                                                <span class="new-shirt-item__price-old">320,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Pokémon: Let's Go - Switch" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/pokemon14.jpg');">
                                                <span class="new-shirt-search">
                                                   <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Pokémon: Let's Go - Switch</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
