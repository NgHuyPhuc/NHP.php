                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid__column-10 product-main">
                            <div class="home-filter border-bottom">
                                <h2 class="home-filter-title">Cyberpunk 2077</h2>
                            ...
                            <div class="home-product">
                                <div class="grid-row">
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Tyger Claws - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp1.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Tyger Claws - Cyberpunk 2077 Gangs</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Valentinos - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp2.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Valentinos - Cyberpunk 2077 Gangs</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Moxes - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp3.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Moxes - Cyberpunk 2077 Gangs</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun tay dài Cyberpunk 2077 - Neon" class="new-shirt-item">
                                            ...
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun tay dài Cyberpunk 2077 - Neon</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun tay dài Cyberpunk 2077 - Original" class="new-shirt-item">
                                            ...
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun tay dài Cyberpunk 2077 - Original</h4>
                                                <span class="new-shirt-item__price-current">280,000đ</span>
                                                <span class="new-shirt-item__price-old">320,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater 6th Street - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp4.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Animals - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp5.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Voodoo Boys - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp6.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Voodoo Boys - Cyberpunk 2077 Gangs</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Cyberpunk 2077 - Neon" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp7.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Cyberpunk 2077 - Neon</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Cyberpunk 2077 - Neon" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp8.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Cyberpunk 2077 - Neon</h4>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Animals - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp9.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Animals - Cyberpunk 2077 Gangs</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Valentinos - Cyberpunk 2077 Gangs" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp10.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Valentinos - Cyberpunk 2077 Gangs</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Hoodie Cyberpunk 2077 - Original" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp11.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Hoodie Cyberpunk 2077 - Original</h4>
                                                <span class="new-shirt-item__price-current">410,000đ</span>
                                                <span class="new-shirt-item__price-old">450,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Sweater Cyberpunk 2077 - Original" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp12.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Sweater Cyberpunk 2077 - Original</h4>
                                                <span class="new-shirt-item__price-current">360,000đ</span>
                                                <span class="new-shirt-item__price-old">400,000đ</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid__column-5 new-shirt-list">
                                        <div href="" alt="Áo thun Cyberpunk 2077 - Original" class="new-shirt-item">
                                            <div class="new-shirt-item-img" style="background-image: url('./asset/img/cbp13.jpg');">
                                                <span class="new-shirt-search">
                                                    <i class="ti-search js-product-details"></i>
                                                </span>
                                            </div>
                                            <div class="new-shirt-item__price">
                                                <h4 class="new-shirt-item-name hover-primary-color">Áo thun Cyberpunk 2077 - Original</h4>
                                                <span class="new-shirt-item__price-current">250,000đ</span>
                                                <span class="new-shirt-item__price-old">290,000đ</span>
                                            </div>
                                        </div>
