                            ...
                            <div class="basic-form">
                                <form method="POST" action="" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="TaiKhoan" class="form-control" placeholder="Tài Khoản">
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Mật Khẩu</label>
                                            <input type="MatKhau" required name="MatKhau" class="form-control" placeholder="Mật Khẩu">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="MaKH" required class="form-control" placeholder="Mã Khách Hàng">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">
